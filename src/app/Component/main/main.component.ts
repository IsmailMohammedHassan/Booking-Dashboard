...
import { HotelService } from 'Services/hotel.service';
 ...
 export class MainComponent implements OnInit {
   ...
   hotelRedirect(hotel: any) {
     ...
     window.location.href = `http://localhost:4200/property/home/hotel/${hotel._id}`;
   }
   campRedirect(camp: any) {
     window.location.href = `http://localhost:4200/property/home/campground/${camp._id}`;
   }
   apartmentRedirect(apartment: any) {
     window.location.href = `http://localhost:4200/property/home/apartment/${apartment._id}`;
   }
 }
